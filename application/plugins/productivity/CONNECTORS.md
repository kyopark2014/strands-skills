...
Plugins are **tool-agnostic** — they describe workflows in terms of categories (chat, project tracker, knowledge base, etc.) rather than specific products. The mcp_servers.list avaalable specific MCP servers, but any MCP server in that category works.
